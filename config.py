...
class rkn(object):
    ...
    START_TXT = """<b> ʜᴇʏ {} 👋 ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ʜᴋ ʀᴇɴᴀᴍᴇ ʙᴏᴛ,

ᴛʜɪꜱ ɪꜱ ᴀɴ ᴀᴅᴠᴀɴᴄᴇᴅ ᴀɴᴅ ᴘᴏᴡᴇʀғᴜʟ 𝟸ɢʙ ʀᴇɴᴀᴍᴇ ʙᴏᴛ. ᴜꜱɪɴɢ ᴛʜɪꜱ ʙᴏᴛ ʏᴏᴜ ᴄᴀɴ ʀᴇɴᴀᴍᴇ ʏᴏᴜʀ ғɪʟᴇꜱ ᴀɴᴅ ᴠɪᴅᴇᴏꜱ, ʏᴏᴜ ᴄᴀɴ ᴄᴏɴᴠᴇʀᴛ ᴠɪᴅᴇᴏ ᴛᴏ ғɪʟᴇꜱ ᴀɴᴅ ғɪʟᴇꜱ ᴛᴏ ᴠɪᴅᴇᴏ 

ғᴏʀ ᴍᴏʀᴇ ғᴇᴀᴛᴜʀᴇꜱ ᴄʜᴇᴄᴋ ᴏᴜʀ ғᴇᴀᴛᴜʀᴇꜱ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ 👇 ᴏʀ ᴜꜱᴇ ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ /hkfeatures ᴛᴏ ꜱᴇᴇ ᴀʟʟ ᴏᴜʀ ғᴇᴀᴛᴜʀᴇꜱ

🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ @Hari_Moviez</b>"""
...
ℹ️ 𝗔𝗻𝘆 𝗢𝘁𝗵𝗲𝗿 𝗛𝗲𝗹𝗽 𝗖𝗼𝗻𝘁𝗮𝗰𝘁 :- <a href=https://t.me/Harikushal>𝗢𝗪𝗡𝗘𝗥 𝗦𝗨𝗣𝗣𝗢𝗥𝗧</a>
"""
...
"""
    ...
    HARIKUSHAL = """📽️<b>ʜᴇʀᴇ ɪꜱ ʏᴏᴜʀ ᴇxᴛʀᴀ ꜰᴇᴀᴛᴜʀᴇ 🎧 ᴀᴜᴅɪᴏ ᴛᴏᴏʟ 🛠️ & 📹 ᴠɪᴅᴇᴏ ᴛᴏᴏʟ 🎬 ʏᴏᴜ ᴄʜᴇᴄᴋ ᴛʜᴇ 🚀 ꜰᴇᴀᴛᴜʀᴇꜱ ᴜꜱɪɴɢ ʙᴇʟᴏᴡ 👇 🔘 ʙᴜᴛᴛᴏɴꜱ ✨</b>"""

    VIDEO_TOOL = """📽️<b><u>ʜᴏᴡ ᴛᴏ ɢᴇɴᴇʀᴀᴛᴇ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ᴏʀ ɢᴇᴛ ꜱᴀᴍᴘʟᴇ ᴠɪᴅᴇᴏ</u></b>

<b>•></b> /ss - ᴜꜱᴇ ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ᴛᴏ ɢᴇɴᴇʀᴀᴛᴇ ꜱᴄʀᴇᴇɴꜱʜᴏᴛꜱ.
<b>•></b> /vs - ᴜꜱᴇ ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ᴛᴏ ɢᴇɴᴇʀᴀᴛᴇ ꜱᴀᴍᴘʟᴇ ᴠɪᴅᴇᴏ.
"""

    AUDIO_TOOL = """📽️<b><u>ʜᴏᴡ ᴛᴏ ɢᴇɴᴇʀᴀᴛᴇ ᴏʀ ʀᴇɴᴀᴍᴇ ʏᴏᴜʀ ᴀᴜᴅɪᴏ ᴛʀᴀᴄᴋ</u>

• /setaudio - 🎵 ꜱᴇᴛ ᴅᴇғᴀᴜʟᴛ ᴀᴜᴅɪᴏ ᴛʀᴀᴄᴋ ꜱᴇʟᴇᴄᴛɪᴏɴ.
• /seeaudio - 🎧 ᴠɪᴇᴡ ᴄᴜʀʀᴇɴᴛ ᴀᴜᴅɪᴏ ᴛʀᴀᴄᴋ ᴘʀᴇғᴇʀᴇɴᴄᴇ.
• /delaudio - 🗑️ ᴅᴇʟᴇᴛᴇ ᴀᴜᴅɪᴏ ᴛʀᴀᴄᴋ ᴘʀᴇғᴇʀᴇɴᴄᴇ.</b>"""
